...
func CustomersdeleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.DeleteCustomerResponse
...
func CreateCustomersdeleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_accounting_customers_id",
		mcp.WithDescription("Delete Customer"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CustomersdeleteHandler(cfg),
	}
}
