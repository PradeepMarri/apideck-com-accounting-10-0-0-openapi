...
func JournalentriesoneHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetJournalEntryResponse
...
func CreateJournalentriesoneTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_accounting_journal-entries_id",
		mcp.WithDescription("Get Journal Entry"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    JournalentriesoneHandler(cfg),
	}
}
