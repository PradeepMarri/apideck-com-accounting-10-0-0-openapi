...
func JournalentriesdeleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/accounting/journal-entries/%s%s", cfg.BaseURL, id, queryString)
		...
		var result models.DeleteJournalEntryResponse
...
func CreateJournalentriesdeleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_accounting_journal-entries_id",
		mcp.WithDescription("Delete Journal Entry"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    JournalentriesdeleteHandler(cfg),
	}
}
