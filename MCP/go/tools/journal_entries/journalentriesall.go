...
func JournalentriesallHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetJournalEntriesResponse
...
func CreateJournalentriesallTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_accounting_journal-entries",
		mcp.WithDescription("List Journal Entries"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    JournalentriesallHandler(cfg),
	}
}
