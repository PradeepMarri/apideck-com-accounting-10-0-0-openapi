...
func CreditnotesaddHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/accounting/credit-notes%s", cfg.BaseURL, queryString)
		...
		var result models.CreateCreditNoteResponse
...
func CreateCreditnotesaddTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_accounting_credit-notes",
		mcp.WithDescription("Create Credit Note"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreditnotesaddHandler(cfg),
	}
}
