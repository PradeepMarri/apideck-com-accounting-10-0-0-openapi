...
func CreditnotesoneHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetCreditNoteResponse
...
func CreateCreditnotesoneTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_accounting_credit-notes_id",
		mcp.WithDescription("Get Credit Note"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreditnotesoneHandler(cfg),
	}
}
