...
func CreditnotesallHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetCreditNotesResponse
...
func CreateCreditnotesallTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_accounting_credit-notes",
		mcp.WithDescription("List Credit Notes"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreditnotesallHandler(cfg),
	}
}
