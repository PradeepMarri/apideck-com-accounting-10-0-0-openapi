...
func CreditnotesdeleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.DeleteCreditNoteResponse
...
func CreateCreditnotesdeleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_accounting_credit-notes_id",
		mcp.WithDescription("Delete Credit Note"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreditnotesdeleteHandler(cfg),
	}
}
