...
func LedgeraccountsallHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetLedgerAccountsResponse
...
func CreateLedgeraccountsallTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_accounting_ledger-accounts",
		mcp.WithDescription("List Ledger Accounts"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    LedgeraccountsallHandler(cfg),
	}
}
