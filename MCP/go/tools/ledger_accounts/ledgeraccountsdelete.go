...
func LedgeraccountsdeleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/accounting/ledger-accounts/%s%s", cfg.BaseURL, id, queryString)
		...
		var result models.DeleteLedgerAccountResponse
...
func CreateLedgeraccountsdeleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_accounting_ledger-accounts_id",
		mcp.WithDescription("Delete Ledger Account"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    LedgeraccountsdeleteHandler(cfg),
	}
}
