...
func LedgeraccountsoneHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetLedgerAccountResponse
...
func CreateLedgeraccountsoneTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_accounting_ledger-accounts_id",
		mcp.WithDescription("Get Ledger Account"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    LedgeraccountsoneHandler(cfg),
	}
}
