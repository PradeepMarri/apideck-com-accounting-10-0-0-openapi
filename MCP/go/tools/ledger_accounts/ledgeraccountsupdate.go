...
func LedgeraccountsupdateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.UpdateLedgerAccountResponse
...
func CreateLedgeraccountsupdateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_accounting_ledger-accounts_id",
		mcp.WithDescription("Update Ledger Account"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    LedgeraccountsupdateHandler(cfg),
	}
}
