...
func InvoicesupdateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.UpdateInvoiceResponse
...
func CreateInvoicesupdateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_accounting_invoices_id",
		mcp.WithDescription("Update Invoice"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    InvoicesupdateHandler(cfg),
	}
}
