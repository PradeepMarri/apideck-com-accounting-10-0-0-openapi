...
func InvoicesallHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetInvoicesResponse
...
func CreateInvoicesallTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_accounting_invoices",
		mcp.WithDescription("List Invoices"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    InvoicesallHandler(cfg),
	}
}
