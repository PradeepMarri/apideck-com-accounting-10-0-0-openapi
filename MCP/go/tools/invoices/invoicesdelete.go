...
func InvoicesdeleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/accounting/invoices/%s%s", cfg.BaseURL, id, queryString)
		...
		var result models.DeleteInvoiceResponse
...
func CreateInvoicesdeleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_accounting_invoices_id",
		mcp.WithDescription("Delete Invoice"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    InvoicesdeleteHandler(cfg),
	}
}
