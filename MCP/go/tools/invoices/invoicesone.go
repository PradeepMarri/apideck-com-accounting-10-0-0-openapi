...
func InvoicesoneHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateInvoicesoneTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_accounting_invoices_id",
		mcp.WithDescription("Get Invoice"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    InvoicesoneHandler(cfg),
	}
}
