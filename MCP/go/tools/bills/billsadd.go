...
func BillsaddHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateBillsaddTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_accounting_bills",
		mcp.WithDescription("Create Bill"),
