...
func BillsoneHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetBillResponse
...
func CreateBillsoneTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_accounting_bills_id",
		mcp.WithDescription("Get Bill"),
