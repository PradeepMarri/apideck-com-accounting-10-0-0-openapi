...
func BillsallHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/accounting/bills%s", cfg.BaseURL, queryString)
		...
		var result models.GetBillsResponse
...
func CreateBillsallTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_accounting_bills",
		mcp.WithDescription("List Bills"),
