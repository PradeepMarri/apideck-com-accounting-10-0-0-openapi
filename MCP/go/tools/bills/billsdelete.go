...
func BillsdeleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.DeleteBillResponse
...
func CreateBillsdeleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_accounting_bills_id",
		mcp.WithDescription("Delete Bill"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    BillsdeleteHandler(cfg),
	}
}
