...
func PurchaseordersallHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetPurchaseOrdersResponse
...
func CreatePurchaseordersallTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_accounting_purchase-orders",
		mcp.WithDescription("List Purchase Orders"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    PurchaseordersallHandler(cfg),
	}
}
