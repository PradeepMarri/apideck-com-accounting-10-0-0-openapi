...
func PurchaseordersoneHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetPurchaseOrderResponse
...
func CreatePurchaseordersoneTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_accounting_purchase-orders_id",
		mcp.WithDescription("Get Purchase Order"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    PurchaseordersoneHandler(cfg),
	}
}
