...
func PurchaseordersaddHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/accounting/purchase-orders%s", cfg.BaseURL, queryString)
		...
		var result models.CreatePurchaseOrderResponse
...
func CreatePurchaseordersaddTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_accounting_purchase-orders",
		mcp.WithDescription("Create Purchase Order"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    PurchaseordersaddHandler(cfg),
	}
}
