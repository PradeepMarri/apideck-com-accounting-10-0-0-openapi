...
func PurchaseordersdeleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.DeletePurchaseOrderResponse
...
func CreatePurchaseordersdeleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_accounting_purchase-orders_id",
		mcp.WithDescription("Delete Purchase Order"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    PurchaseordersdeleteHandler(cfg),
	}
}
