...
func CompanyinfooneHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/accounting/company-info%s", cfg.BaseURL, queryString)
		...
		var result models.GetCompanyInfoResponse
...
func CreateCompanyinfooneTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_accounting_company-info",
		mcp.WithDescription("Get company info"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CompanyinfooneHandler(cfg),
	}
}
