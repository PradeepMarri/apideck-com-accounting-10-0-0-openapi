...
func SuppliersdeleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.DeleteSupplierResponse
...
func CreateSuppliersdeleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_accounting_suppliers_id",
		mcp.WithDescription("Delete Supplier"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    SuppliersdeleteHandler(cfg),
	}
}
