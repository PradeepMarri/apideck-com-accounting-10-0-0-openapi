...
func SuppliersoneHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetSupplierResponse
...
func CreateSuppliersoneTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_accounting_suppliers_id",
		mcp.WithDescription("Get Supplier"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    SuppliersoneHandler(cfg),
	}
}
