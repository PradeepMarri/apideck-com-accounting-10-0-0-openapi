...
func SuppliersallHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetSuppliersResponse
...
func CreateSuppliersallTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_accounting_suppliers",
		mcp.WithDescription("List Suppliers"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    SuppliersallHandler(cfg),
	}
}
