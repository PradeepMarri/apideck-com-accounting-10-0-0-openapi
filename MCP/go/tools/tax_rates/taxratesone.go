...
func TaxratesoneHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetTaxRateResponse
...
func CreateTaxratesoneTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_accounting_tax-rates_id",
		mcp.WithDescription("Get Tax Rate"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    TaxratesoneHandler(cfg),
	}
}
