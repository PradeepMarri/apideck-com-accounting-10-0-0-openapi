...
func TaxratesdeleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateTaxratesdeleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_accounting_tax-rates_id",
		mcp.WithDescription("Delete Tax Rate"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    TaxratesdeleteHandler(cfg),
	}
}
