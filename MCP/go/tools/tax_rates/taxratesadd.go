...
func TaxratesaddHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/accounting/tax-rates%s", cfg.BaseURL, queryString)
		...
		var result models.CreateTaxRateResponse
...
func CreateTaxratesaddTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_accounting_tax-rates",
		mcp.WithDescription("Create Tax Rate"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    TaxratesaddHandler(cfg),
	}
}
