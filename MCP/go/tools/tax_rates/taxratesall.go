...
func TaxratesallHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetTaxRatesResponse
...
func CreateTaxratesallTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_accounting_tax-rates",
		mcp.WithDescription("List Tax Rates"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    TaxratesallHandler(cfg),
	}
}
