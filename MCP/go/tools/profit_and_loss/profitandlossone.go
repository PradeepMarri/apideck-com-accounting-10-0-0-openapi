...
func ProfitandlossoneHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/accounting/profit-and-loss%s", cfg.BaseURL, queryString)
		...
		var result models.GetProfitAndLossResponse
...
func CreateProfitandlossoneTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_accounting_profit-and-loss",
		mcp.WithDescription("Get Profit and Loss"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ProfitandlossoneHandler(cfg),
	}
}
