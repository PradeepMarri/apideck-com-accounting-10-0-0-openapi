...
func InvoiceitemsupdateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/accounting/invoice-items/%s%s", cfg.BaseURL, id, queryString)
		...
		var result models.UpdateInvoiceItemsResponse
...
func CreateInvoiceitemsupdateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_accounting_invoice-items_id",
		mcp.WithDescription("Update Invoice Item"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    InvoiceitemsupdateHandler(cfg),
	}
}
