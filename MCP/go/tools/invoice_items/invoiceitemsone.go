...
func InvoiceitemsoneHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetInvoiceItemResponse
...
func CreateInvoiceitemsoneTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_accounting_invoice-items_id",
		mcp.WithDescription("Get Invoice Item"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    InvoiceitemsoneHandler(cfg),
	}
}
