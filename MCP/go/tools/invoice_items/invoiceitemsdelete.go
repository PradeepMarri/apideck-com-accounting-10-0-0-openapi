...
func InvoiceitemsdeleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.DeleteTaxRateResponse
...
func CreateInvoiceitemsdeleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_accounting_invoice-items_id",
		mcp.WithDescription("Delete Invoice Item"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    InvoiceitemsdeleteHandler(cfg),
	}
}
