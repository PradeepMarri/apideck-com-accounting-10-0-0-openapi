...
func InvoiceitemsallHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetInvoiceItemsResponse
...
func CreateInvoiceitemsallTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_accounting_invoice-items",
		mcp.WithDescription("List Invoice Items"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    InvoiceitemsallHandler(cfg),
	}
}
